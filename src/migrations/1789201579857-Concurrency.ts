...
export class Concurrency1789201579857 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "balance" numeric(12,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "products" ADD CONSTRAINT "CHK_products_stock" CHECK ("stock" >= 0)`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "CHK_users_balance" CHECK ("balance" >= 0)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "CHK_users_balance"`);
